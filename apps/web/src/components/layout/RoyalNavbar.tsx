  ...
  return (
    <nav className="fixed z-50 top-3 left-1/2 -translate-x-1/2 w-[96%] max-w-6xl">
      ...
      <div className="
        ...
        before:border before:border-[#D3AF37] before:pointer-events-none
      ">
        ...
        <div className="hidden sm:flex items-center gap-10 text-[11px] uppercase tracking-[0.4em] text-[#FFEBC7]">
          ...
          <div className="hidden lg:flex items-center gap-4 text-[#D4AF37]">
          ...
          {!user && (
            <Link href="/auth"
              ...
              before:absolute before:inset-[-4px] before:rounded-full before:border before:border-[#D4AF37] before:pointer-events-none">
              Login / Signup
            </Link>
          )}
      ...
      {/* Mobile Drawer */}
      {open && (
        <div className="mt-4 sm:hidden bg-[#6D1A1A]/95 backdrop-blur-xl border border-[#D4AF37] rounded-3xl p-6 space-y-5 text-[#FFEBC7]">
          ...
          <div className="flex gap-4 pt-4 text-[#D4AF37]">
            <Instagram size={20}/>
            <FaXTwitter size={18}/>
            <Youtube size={20}/>
            <Facebook size={20}/>
