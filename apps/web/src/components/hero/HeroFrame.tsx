    ...
    ">
      ...
      <div className="order-2 lg:order-none lg:col-span-7 text-center lg:text-left">
        ...
        <div className="flex justify-center lg:justify-start items-center gap-4 sm:gap-6 mb-10 lg:mb-14">
          ...
          <span className="uppercase tracking-[0.45em] text-gold text-[0.6rem] sm:text-xs">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start">
          <a
            href="/shop"
            className="px-10 sm:px-14 lg:px-16 py-4 sm:py-5 border-2 border-gold uppercase tracking-[0.35em] text-xs sm:text-sm hover:bg-[#D4AF37] hover:text-white transition"
          >
            Enter Royal Bazaar
          </a>
          <a
